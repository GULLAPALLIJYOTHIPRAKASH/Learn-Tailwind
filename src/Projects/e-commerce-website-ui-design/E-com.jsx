    ...
    <nav className="nav-container  bg-white border-b-1 border-gray-100 relative">
        <div className="nav-center max-w-[1550px] mx-auto p-[20px] flex justify-between items-center ">
            ...
            <div className="sub-nav md:order-3">
             ...
             <ul className={`nav-main-links     md:w-[100%] md:bg-white  md:flex md:justify-center md:space-x-8 md:items-center order-2`}>

                    <li className=""><a href="#" className="text-base font-medium text-gray-900  ">Home</a></li>
                    <li className=""><a href="#" className="text-base font-medium text-gray-900  ">Shop</a></li>
                    <li className=""><a href="#" className="text-base font-medium text-gray-900  ">New Arrivals</a></li>
                    <li className=""><a href="#" className="text-base font-medium text-gray-900  ">Sale</a></li>
                    <li className=""><a href="#" className="text-base font-medium text-gray-900  ">About</a></li>
