        ...
        <div className="banner-container bg-white flex  justify-center items-center">
            <div className="banner-center max-w-[1550px] mx-auto p-[20px] relative  z-6">
                <div className="heading mt-20">
                    ...
                    <button className="bg-[#ffaf4d] text-white text-base py-2 px-5 rounded-full uppercase font-medium mt-4 ml-[70%] sm:ml-[55%] md:ml-[58%] lg:ml-[60%] xl:ml-[58%] cursor-pointer hover:opacity-80 ">Buy Now</button>
                </div>
